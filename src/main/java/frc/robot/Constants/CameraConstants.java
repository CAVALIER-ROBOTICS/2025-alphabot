...
public class CameraConstants {
    ...
    public static final Transform3d LOCALIZATION_CAM_TWO_OFFSET = new Transform3d(new Translation3d(-0.00635, -0.184, 0.08), new Rotation3d(0, Math.toRadians(5), 0.0));
}